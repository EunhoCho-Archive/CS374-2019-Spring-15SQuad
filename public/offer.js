            ...
            if (type === 'Modify') {
                ...
                database.ref(databaseRef).once('value', function (snapshot) {
                    if(sessionStorage.getItem('detailtype') === "Negotiations"){
                        ...
                        if (offerOwner !== "Me"){
                            document.getElementById('name').innerHTML = "<i class=\"icon sign-in\"></i>Negotiation about worker from " + offerOwner + " to Me";
                        }
                        else{
                            document.getElementById('name').innerHTML = "<i class=\"icon sign-out\"></i>Negotiation about worker from Me to " + snapshot.val().to;
                        }
                    }
                    else{
